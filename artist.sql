...
Source Database       : artist

Target Server Type    : MYSQL
Target Server Version : 50709
File Encoding         : 65001

Date: 2016-06-02 20:59:11
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for artist_address
-- ----------------------------
...
CREATE TABLE `artist_address` (
  ...
  `consignee` varchar(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  CONSTRAINT `address_fk1` FOREIGN KEY (`user_id`) REFERENCES `artist_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of artist_address
-- ----------------------------
INSERT INTO `artist_address` VALUES ('1', '7', '白宫', '奥巴马', '1', '440000', '440100', '440105', '仲恺路500号', '510000', null, '13763394636', null, '0', '0', '0', '0', '0');
INSERT INTO `artist_address` VALUES ('2', '7', '学校', '凯里欧文', '1', '440000', '440100', '440105', '仲恺路500号', '510000', null, '13763394636', null, '0', '0', '0', '0', '0');
INSERT INTO `artist_address` VALUES ('3', '6', '克利夫兰', '香波特', '1', '440000', '440100', '440105', '仲恺路500号', '510000', null, '664636', null, '0', '1462339100', '1463276907', '6', '6');
INSERT INTO `artist_address` VALUES ('4', '8', '伯纳乌', 'C罗', '1', '440000', '440100', '440105', '仲恺路500号', '510000', null, '664636', null, '0', '1462349572', '1462349572', '8', '8');
INSERT INTO `artist_address` VALUES ('5', '8', '克利夫兰', '香波特', '1', '150000', '150200', '150203', '仲恺路500号', '510000', null, '664636', null, '0', '1463210594', '1463210594', '8', '8');
INSERT INTO `artist_address` VALUES ('6', '6', '伯纳乌', 'C罗', '1', '220000', '220100', '220103', '仲恺路500号', '510000', null, '664636', null, '0', '1463282727', '1463282727', '6', '6');

-- ----------------------------
-- Table structure for artist_article
-- ----------------------------
DROP TABLE IF EXISTS `artist_article`;
CREATE TABLE `artist_article` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `author_id` tinyint(11) NOT NULL,
  `title` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `con_head` text COLLATE utf8_unicode_ci,
  `con_middle` text COLLATE utf8_unicode_ci,
  `con_foot` text COLLATE utf8_unicode_ci,
  `tags` text COLLATE utf8_unicode_ci,
  `create_time` char(10) COLLATE utf8_unicode_ci NOT NULL,
  `update_time` char(10) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of artist_article
-- ----------------------------
INSERT INTO `artist_article` VALUES ('1', '1', '再见，黑曼巴', '二十年的职业生涯，我们心里都明白，坚韧如科比，说了再见，就再也不会回到他最爱的NBA赛场了。 All he has got to do is decide to go and the hardest part is over. 也许科比已经走到了职业生涯的最低谷，却也收到了前所未有的支持，这种温暖是炙热的，是铭心的，球迷们似乎也从未如此团结过，正是这份对篮球的爱，让JRs聚在了一起。无数个渺小，凑在一起便成了这份独一无二的伟大。', '距离第一次看科比打球已经过去了十几年，岁月送来了十多年后的你，也送走了十年前的我们。世界老了十岁，但你还是你，我还是我，一切还是一个圆，从起点走到终点，加内特还在森林狼，邓肯还在马刺，老大也依旧在湖人。十年时间我以为做了一个很长很长的梦，其实是，走了一段很远很远的路。', '仅以老大消逝的一面，足令我们享用一生。好好珍惜这最后一场球吧，终场哨音响起时，轻轻地说一声再见，这大概就是最后的告别了。多希望人是可以穿越时空的，到未来的某一天，当我们有机会亲临斯台普斯听到湖人主场哨音的时候，就又回到今天了。', '科比，篮球', '1449934775', '1449934775');
INSERT INTO `artist_article` VALUES ('2', '2', '了不起的盖茨比', '也许菲茨杰拉德在写《了不起的盖茨比》时，并没有想到这部小说日后的辉煌。《了不起的盖茨比》从开拍之日起，人们的关注点便一直集中在莱昂纳多饰演的盖茨比身上，他的20年代正装复古造型甚至影响了T台的潮流。', 'Nick Carraway与Jay Gatsby为邻，更是整个故事的叙述者，Nick既在事外又在事内，既是局外人又是见证人，Nick始终保持着冷静理性的判断，见证了盖茨比美国梦的破灭。他的着装相比高调的Gatsby显得低调许多，但却不缺乏细节。', '“富二代”Tom Buchanan是躺在前人留下的财富上盛气凌人地挥霍的典型，他总是通过炫耀财富来表现自己的优越地位和高人一等，连穿衣也不例外。性格凶狠的Tom喜爱马球运动，超高筒的马靴是他的风格标志，除此之外，复古硬草帽也是他经常佩戴的配饰。', '电影，了不起的盖茨比，复古', '1449934775', '1449934775');
INSERT INTO `artist_article` VALUES ('3', '1', '詹姆斯', '6666', '6666', '66666', '篮球', '1463276795', '1463276795');

-- ----------------------------
-- Table structure for artist_cart
-- ----------------------------
DROP TABLE IF EXISTS `artist_cart`;
CREATE TABLE `artist_cart` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of artist_cart
-- ----------------------------

-- ----------------------------
-- Table structure for artist_comment
-- ----------------------------
...
CREATE TABLE `artist_comment` (
  ...
  KEY `comment_fk_2` (`article_id`),
  CONSTRAINT `comment_fk1` FOREIGN KEY (`user_id`) REFERENCES `artist_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `comment_fk2` FOREIGN KEY (`article_id`) REFERENCES `artist_article` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of artist_comment
-- ----------------------------
INSERT INTO `artist_comment` VALUES ('14', '0', '7', 'admin', '2', '莎士比亚', '0', '0', '0', '0', '1454596807', '1463209755');
INSERT INTO `artist_comment` VALUES ('15', '0', '7', 'admin', '2', 'dd', '0', '0', '0', '0', '1454596853', '1454596853');
INSERT INTO `artist_comment` VALUES ('16', '0', '8', 'iving', '2', 'rrrrr', '0', '0', '0', '0', '1461917316', '1461917316');
INSERT INTO `artist_comment` VALUES ('17', '0', '8', 'iving', '2', '666666', '0', '0', '0', '0', '1461917356', '1461917356');
INSERT INTO `artist_comment` VALUES ('18', '0', '8', 'iving', '2', '666666', '0', '0', '0', '0', '1461917369', '1461917369');
INSERT INTO `artist_comment` VALUES ('19', '0', '6', 'owen', '2', 'ffff', '0', '0', '0', '0', '1462335843', '1462335843');
INSERT INTO `artist_comment` VALUES ('20', '0', '8', 'iving', '1', '777', '0', '0', '0', '0', '1462349484', '1462349484');
INSERT INTO `artist_comment` VALUES ('21', '0', '8', 'iving', '1', '好鞋', '0', '0', '0', '0', '1463210202', '1463210202');
INSERT INTO `artist_comment` VALUES ('22', '0', '6', 'owen', '1', 'kobi', '0', '0', '0', '0', '1463233139', '1463233139');
INSERT INTO `artist_comment` VALUES ('23', '0', '6', 'owen', '1', 'kobe', '0', '0', '0', '0', '1463282628', '1463282628');
...
CREATE TABLE `artist_images` (
  ...
  `one` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `two` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `three` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `four` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `five` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `artist_images` VALUES ('1', '1', null, '1_sisth.jpg', '1_first.jpg', '1_second.jpg', '1_third.jpg', '1_forth.jpg', '1_fifth.jpg');

-- ----------------------------
-- Table structure for artist_order
-- ----------------------------
DROP TABLE IF EXISTS `artist_order`;
CREATE TABLE `artist_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `sn` varchar(32) COLLATE utf8_unicode_ci NOT NULL COMMENT '订单号',
  `consignee` varchar(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '联系人',
  `country` int(11) DEFAULT '0',
  `province` int(11) DEFAULT '0',
  `city` int(11) DEFAULT '0',
  `district` int(11) DEFAULT '0',
  ...
  `payment_name` varchar(120) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `payment_fee` decimal(10,2) DEFAULT '0.00' COMMENT '支付费用',
  `shipment_status` int(11) NOT NULL DEFAULT '0' COMMENT '配送状态',
  ...
  `invoice` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '发票',
  ...
  CONSTRAINT `order_fk1` FOREIGN KEY (`user_id`) REFERENCES `artist_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of artist_order
-- ----------------------------
INSERT INTO `artist_order` VALUES ('4', '6', '201605041341445526', 'C罗', '1', '440000', '440100', '440105', '仲恺路500号', '510000', null, '664636', 'owen@qq.com', '', '2', '30', '0', '', '0.00', '90', '0', null, '18.00', '22342.25', '0.00', null, '10', null, null, '1462340504', '1463282859', '6', '6');
INSERT INTO `artist_order` VALUES ('5', '8', '201605041613211869', 'C罗', '1', '440000', '440100', '440105', '仲恺路500号', '510000', null, '664636', 'iving@163.com', '', '2', '10', '0', '', '0.00', '70', '0', null, '18.00', '2037.24', '0.00', null, '10', null, null, '1462349601', '1463277088', '8', '6');
INSERT INTO `artist_order` VALUES ('6', '8', '201605141523257588', '香波特', '1', '150000', '150200', '150203', '仲恺路500号', '510000', null, '664636', 'iving@163.com', '', '2', '10', '0', '', '0.00', '0', '0', null, '18.00', '2773.48', '0.00', null, '10', null, null, '1463210605', '1463210605', '8', '8');
INSERT INTO `artist_order` VALUES ('7', '6', '201605150948353555', '香波特', '1', '440000', '440100', '440105', '仲恺路500号', '510000', null, '664636', 'owen@qq.com', '', '2', '10', '0', '', '0.00', '0', '0', null, '18.00', '482.25', '0.00', null, '10', null, null, '1463276915', '1463276915', '6', '6');
INSERT INTO `artist_order` VALUES ('8', '6', '201605151126156890', 'C罗', '1', '220000', '220100', '220103', '仲恺路500号', '510000', null, '664636', 'owen@qq.com', '', '2', '10', '0', '', '0.00', '0', '0', null, '18.00', '1346.24', '0.00', null, '10', null, null, '1463282775', '1463282775', '6', '6');

-- ----------------------------
-- Table structure for artist_product
-- ----------------------------
...
CREATE TABLE `artist_product` (
  ...
  `back` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `product_fk1` (`aid`),
  CONSTRAINT `product_fk1` FOREIGN KEY (`aid`) REFERENCES `artist_article` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of artist_product
-- ----------------------------
INSERT INTO `artist_product` VALUES ('1', '1', 'Second Means退役纪念T恤 99.00RMB', '1', '99.00', '黑，白', 'M,L,XL,XXL', '/uploads/back20161217owen.jpg', '/uploads/back20161217owen.jpg', '退役纪念T恤', '科比在退役信里写道：And that’s OK.I’m ready to let you go.\r\n但是，我们还未准备好就这样和你告别啊。老大带给我们的美好，永存不移。', '1', '1', '1450332308', '1450333239', '1', '1');
INSERT INTO `artist_product` VALUES ('2', '2', 'RICHARD JAMES 蓝色羊毛西装外套 3760.00RMB', '1', '3760.00', '灰，蓝，黑', 'M,L,XL,XXL', '/uploads/front20151218owen.jpg', '/uploads/front20151218owen.jpg', '毛呢西装', '毛呢西装从来没有退出过时装的舞台。从20年代到今天，毛呢外套一直是男人们钟爱的衣品。尤其到了寒冷的秋冬季，一件高品质的毛呢西装外套不仅能帮你抵御寒冷，更能修饰身材。', '1', '1', '1450332308', '1450332308', '1', '1');
INSERT INTO `artist_product` VALUES ('3', '2', 'Hackett London镂空圆形短檐皮环草帽 464.25RMB', '1', '464.25', '黄', 'M,L,XL,XXL', '/uploads/front20160409owen.jpg', '/uploads/front20160409owen.jpg', '草帽', '草帽从未退出过时尚的舞台，毫无疑问拥有一顶高品质的经典草帽，能让你毫无顾虑的用它一辈子。现代都市人更倾向于用草帽搭配休闲装，其实搭配正装一样能凸显草帽的魅力。', '1', '1', '1450332308', '1450332308', '1', '1');
INSERT INTO `artist_product` VALUES ('4', '2', 'IMMY CHOO 皮靴 1809.74RMB', '1', '1809.74', '黑，棕', '40,41,42,43', '/uploads/front20151220owen.jpg', '/uploads/front20151220owen.jpg', '马靴', '如今的男士马靴少有特别高筒的设计，在风行马球运动的20年代，上流社会的男士们都会备几双精良的高筒马靴以备所需。对于身材高大的男人来说，高筒靴不但能修饰身材，更显与众不同。', '1', '1', '1450332308', '1450332308', '1', '1');
INSERT INTO `artist_product` VALUES ('5', '2', 'Paul Smith 灰色格子西服三件套 18100.00RMB', '1', '18100.00', '灰，黑', 'M,L,XL,XXL', '/uploads/front20151219owen.jpg', '/uploads/front20151219owen.jpg', '三件套西装', '三件套西装可能是西装里面价位最为惊人的，然而性价比却也是最高的。无论周末，朋友聚会，晚宴还是工作场合都能够派上用场，只需做几乎不动脑筋的搭配就能够创造出完全不同的造型。', '1', '1', '1450332308', '1450332308', '1', '1');
INSERT INTO `artist_product` VALUES ('6', '1', 'Kobe名言款浮雕手机壳 49.00RMB', '1', '49.00', '黑，红，紫', '5.0吋,4.7吋,5.5吋', '/uploads/back20161017owen.jpg', '/uploads/back20161017owen.jpg', '名言款浮雕手机壳', '进口软硬二合一材质，进口3D浮雕烤漆工艺，经过无限次HB级别的磨砂处理，颜色鲜艳，质感细腻，Mimark机器生产，原装机器原装油墨，杜绝油墨污染，不含甲醛。不但带来视觉的愉悦，更带来安全健康的碰触感。', '1', '1', '1450332308', '1450333239', '1', '1');
INSERT INTO `artist_product` VALUES ('7', '1', 'JRS致敬科比篮球鞋 199.00RMB', '1', '199.00', '棕', '均码', '/uploads/back20161117owen.jpg', '/uploads/back20161117owen.jpg', 'JRS篮球鞋', '本款篮球鞋更富运动弹性，更为舒适透气。正面印有科比励志名言，背面印有JRs标志，打气口是经典紫金配色的24号印花。纪念这个号码背后的所有伟大，致敬科比职业篮球生涯的所有不朽时刻。', '1', '1', '1450332308', '1450333239', '1', '1');
INSERT INTO `artist_product` VALUES ('8', '1', '耐克Nike Zoom Kobe 11 Elite科比11代篮球鞋1328.24RMB', '1', '1328.24', '紫，红', '40,41,42,43', '/uploads/back20161218owen.jpg', '/uploads/back20161218owen.jpg', '科比11代', '众所周知，如果不发生陨石撞击地球级别的意外，Kobe 11 Elite将成为科比球员生涯中最后一款签名鞋。', '1', '1', '1450332308', '1450333239', '1', '1');

-- ----------------------------
-- Table structure for artist_role
-- ----------------------------
...
-- ----------------------------
-- Records of artist_role
-- ----------------------------
INSERT INTO `artist_role` VALUES ('1', '超级管理员', null, null);
INSERT INTO `artist_role` VALUES ('2', '普通用户', null, null);

-- ----------------------------
-- Table structure for artist_scomment
-- ----------------------------
DROP TABLE IF EXISTS `artist_scomment`;
CREATE TABLE `artist_scomment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `username` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `updated_at` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `scomment_fk_1` (`user_id`),
  KEY `scomment_fk_2` (`story_id`),
  CONSTRAINT `scomment_fk1` FOREIGN KEY (`user_id`) REFERENCES `artist_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `scomment_fk2` FOREIGN KEY (`story_id`) REFERENCES `artist_story` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of artist_scomment
-- ----------------------------

-- ----------------------------
-- Table structure for artist_story
-- ----------------------------
DROP TABLE IF EXISTS `artist_story`;
CREATE TABLE `artist_story` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  ...
  `updated_at` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `story_fk_1` (`user_id`),
  CONSTRAINT `story_fk1` FOREIGN KEY (`user_id`) REFERENCES `artist_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of artist_story
-- ----------------------------

-- ----------------------------
-- Table structure for artist_tag
-- ----------------------------
...
-- ----------------------------
-- Records of artist_tag
-- ----------------------------

-- ----------------------------
-- Table structure for artist_user
-- ----------------------------
...
-- ----------------------------
-- Records of artist_user
-- ----------------------------
INSERT INTO `artist_user` VALUES ('1', 'james', 'RGQ-zNZ-gqKNjHBJHYOsREHF7gB3fZG7', null, null, '$2y$13$uWIEiX760Lo3rLqH5Yj.y.W6kyOMJli.uCt2keSD04fAS0UvvGRLW', 'love@qq.com', '0', '1', '0', '0', '2');
INSERT INTO `artist_user` VALUES ('6', 'owen', 'gUFkF9NYyHv51lNaalu_Zhv8YjY8dQdw', null, null, '$2y$13$OhM1bQhY6gw2jCTQEKYpBOB/r2D5iiFsIZS3QH7fV/DCX6ZrJtEiG', 'owen@qq.com', '0', '1', '0', '0', '2');
INSERT INTO `artist_user` VALUES ('7', 'admin', 'fsQlPI5i7DqZecI5ulhy4YW1xPq_y7bp', null, null, '$2y$13$65wDAd9QFpBTJhPSc/TQNuKv66SKUvykhE4Z2F7O4HfQQm/7IhqQW', '11193480680@qq.com', '0', '1', '0', '0', '1');
INSERT INTO `artist_user` VALUES ('8', 'iving', 'WfYMcJNSW-ZrKhfDkAQ-2mmsfPrVPzPS', null, null, '$2y$13$I5qgAu.yrXzYkCuVeLVCB.A.osv7m4/XIuJ8VlC1zPScI99pfY4q.', 'iving@163.com', '0', '1', '1461854204', '1462330071', '2');
INSERT INTO `artist_user` VALUES ('9', 'love', 'u7CvvUEEH3aLUmvGaAiBioQVWF7_nNWV', null, null, '$2y$13$hIwELECsnqXsW/mrMzJ6geb//iwQYzWie5qv0KBHIn2KmfsBKGZwm', 'loveivying@163.com', '0', '1', '1463237457', '1463237457', '2');
...
CREATE TABLE `order_product` (
  ...
  CONSTRAINT `order_product_fk1` FOREIGN KEY (`order_id`) REFERENCES `artist_order` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `order_product_fk2` FOREIGN KEY (`product_id`) REFERENCES `artist_product` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of order_product
-- ----------------------------
INSERT INTO `order_product` VALUES ('1', '6', '4', '5', '', 'Paul Smith 灰色格子西服三件套 18100.00RMB', '1', '0.00', '18100.00', '灰', '0', '1462340505', '1462340505');
INSERT INTO `order_product` VALUES ('2', '6', '4', '3', '', 'Hackett London镂空圆形短檐皮环草帽 464.25RMB', '1', '0.00', '464.25', '黄', '0', '1462340505', '1462340505');
INSERT INTO `order_product` VALUES ('3', '6', '4', '2', '', 'RICHARD JAMES 蓝色羊毛西装外套 3760.00RMB', '1', '0.00', '3760.00', '蓝', '0', '1462340505', '1462340505');
INSERT INTO `order_product` VALUES ('4', '8', '5', '6', '', 'Kobe名言款浮雕手机壳 49.00RMB', '2', '0.00', '49.00', '黑', '4', '1462349602', '1462349602');
INSERT INTO `order_product` VALUES ('5', '8', '5', '1', '', 'Second Means退役纪念T恤 99.00RMB', '3', '0.00', '99.00', '白', '0', '1462349602', '1462349602');
INSERT INTO `order_product` VALUES ('6', '8', '5', '8', '', '耐克Nike Zoom Kobe 11 Elite科比11代篮球鞋1328.24RMB', '1', '0.00', '1328.24', '紫', '40', '1462349603', '1462349603');
INSERT INTO `order_product` VALUES ('7', '8', '5', '1', '', 'Second Means退役纪念T恤 99.00RMB', '2', '0.00', '99.00', '黑', '0', '1462349603', '1462349603');
INSERT INTO `order_product` VALUES ('8', '8', '5', '6', '', 'Kobe名言款浮雕手机壳 49.00RMB', '2', '0.00', '49.00', '黑', '5', '1462349603', '1462349603');
INSERT INTO `order_product` VALUES ('9', '8', '6', '8', '', '耐克Nike Zoom Kobe 11 Elite科比11代篮球鞋1328.24RMB', '2', '0.00', '1328.24', '紫', '42', '1463210605', '1463210605');
INSERT INTO `order_product` VALUES ('10', '8', '6', '1', '', 'Second Means退役纪念T恤 99.00RMB', '1', '0.00', '99.00', '黑', '0', '1463210605', '1463210605');
INSERT INTO `order_product` VALUES ('11', '6', '7', '3', '', 'Hackett London镂空圆形短檐皮环草帽 464.25RMB', '1', '0.00', '464.25', '黄', '0', '1463276915', '1463276915');
INSERT INTO `order_product` VALUES ('12', '6', '8', '8', '', '耐克Nike Zoom Kobe 11 Elite科比11代篮球鞋1328.24RMB', '1', '0.00', '1328.24', '红', '41', '1463282775', '1463282775');
